...
| Маршруты используются для связи URL с контроллерами или анонимными функциями, 
| которые должны быть выполнены, когда пользователь переходит на данную страницу. 
*/
